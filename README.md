...
How to build 
------------
Build project using maven on eclipse IDE. 

1. File - Import - Existing Maven Projects - Set Root Directory using Browser.
2.Import Database from file 'projectdb.sql' in MySQL

Run app
------------

1. Right Click and run the project on server.
